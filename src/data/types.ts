...
export const typeGroups: TypeGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { no: "03", zh: "萊尼爾", en: "Lynel" },
      { no: "04", zh: "主線任務", en: "Main Story", videosOnly: true },
      { no: "05", zh: "神廟特解", en: "Shrine Strategies", videosOnly: true },
      { no: "06", zh: "餘料機制", en: "Fuse Mechanics" },
      { no: "07", zh: "纏桿", en: "Stick Desync Clipping" },
      { no: "08", zh: "隱藏(剔除)", en: "Cull" },
      { no: "09", zh: "黏手與並列", en: "Smuggle & Zuggle" },
      { no: "10", zh: "過載", en: "Overload" },
      { no: "11", zh: "偷襲機制", en: "Sneakstrike" },
      { no: "12", zh: "道具複製", en: "Item Duplication" },
      { no: "13", zh: "盾擋重置", en: "Shield Block Reset" },
      { no: "14", zh: "虛化裝備", en: "Void Dip & Despawn Interrupt" },
      { no: "15", zh: "連噴火箭盾", en: "Pocket Rockets" },
      { no: "16", zh: "序章大師劍", en: "MsgNotFound Sword in Prologue" },
      { no: "17", zh: "序章林克繼承", en: "Prologue Escape" },
    ],
  },
  {
    game: "eow",
