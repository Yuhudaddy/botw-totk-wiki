...
export const typeGroups: TypeGroup[] = [
  {
    ...
    items: [
      ...
      { no: "14", zh: "觀眾提問", en: "Viewer Replies", videosOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { no: "16", zh: "連噴火箭盾", en: "Pocket Rockets" },
      { no: "17", zh: "序章大師劍", en: "MsgNotFound Sword in Prologue" },
      { no: "18", zh: "序章林克繼承", en: "Prologue Escape" },
    ],
  },
  {
    game: "eow",
