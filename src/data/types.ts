...
export const typeGroups: TypeGroup[] = [
  {
    ...
    items: [
      ...
      { no: "07", zh: "劍之考驗", en: "Trial of the Sword (DLC1)", videosOnly: true },
      { no: "08", zh: "新手學習", en: "Beginners", videosOnly: true },
      { no: "09", zh: "神廟特解", en: "Shrine Strategies", videosOnly: true },
      { no: "10", zh: "技巧指法", en: "Inputs", videosOnly: true },
      { no: "11", zh: "主線任務", en: "Main Story", videosOnly: true },
      { no: "12", zh: "裝備複製", en: "Equipment Duping", videosOnly: true },
      { no: "13", zh: "回應觀眾", en: "Viewer Replies", videosOnly: true },
      { no: "14", zh: "不廢話系列", en: "Zero Fluff", videosOnly: true },
    ],
  },
  {
    game: "totk",
