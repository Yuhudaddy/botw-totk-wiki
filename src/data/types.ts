...
export const typeGroups: TypeGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { no: "03", zh: "主線任務", en: "Main Story", videosOnly: true },
      ...
      { no: "11", zh: "道具複製", en: "Item Duplication" },
      { no: "12", zh: "盾擋重置", en: "Shield Block Reset" },
      { no: "13", zh: "虛化裝備", en: "Void Dip & Despawn Interrupt" },
      { no: "14", zh: "連噴火箭盾", en: "Pocket Rockets" },
      { no: "15", zh: "序章大師劍", en: "MsgNotFound Sword in Prologue" },
      { no: "16", zh: "序章林克繼承", en: "Prologue Escape" },
    ],
  },
  {
    game: "eow",
