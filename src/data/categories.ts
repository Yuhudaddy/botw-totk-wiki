...
export const totkCategory: GameCategory = {
  ...
  cats: [
    ...
    { no: "02", title: "餘料儲存 Fuse Storage", desc: "將餘料狀態儲存以達成各種效果的基礎技巧。", meta: "1 篇 · ～1.4.3", status: "active", tag: "儲存類" },
...
export const botwCategory: GameCategory = {
  ...
  cats: [
    { no: "01", title: "過場必殺劍 Obliterator", desc: "過場動畫觸發的一擊必殺劍 (Cutscene One-Hit Obliterator)。", meta: "番外58 · NS2", status: "active", tag: "必殺技類" },
    { no: "02", title: "盾擋類 Shield", desc: "轉向盾擋重置 Turnaround SBR 等盾擋相關技巧。", meta: "番外10.5 · NS2", status: "active", tag: "盾擋類" },
