    ...
    methods: [
      ...
      },
      {
        ...
        steps: [
          ...
          "游標移動到弓箭頁籤（第一頁或第三頁）的第四列，右類比往右(或左) → 左類比往下（或 + 其他左類比操作），游標不在任何格位上點擊 A 畫面出現在系統頁的任意視窗上，解鎖脫頁的系統頁籤",
          "按 B 取消左類比讓游標回到武器或弓箭頁，游標脫頁到隔壁頁籤之後，右類比移動到重要道具頁籤，往右移動左類比的游標，選擇讀取，游標移動到要讀取的檔案",
        ...
        note: [
          "※ 若未做步驟 4，步驟 8 的時候游標沒辦法移動（會卡在系統選單）。步驟 8 的地方按 A 之前，先按 + 號打開暫停，右類比 ⇨ → 左類比 ⇨ → 右類比 ⇦ → 按 + → B，脫頁一次游標之後讓游標歸位就可以移動游標。",
