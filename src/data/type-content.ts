        ...
        sections: [
          {
            ...
            steps: [
              ...
              "虛幽化感染一把武器 W0，用 W0 在旁邊可調式過載，觸發後隨意丟棄 W0。過程中__空手撿起一兩次 W1，避免純虛化的 W1 因為可調式過載地上太多武器而被消滅__",
              "裝備 W1 按照以下順序，虛幽化感染 1 把武器和 2 面盾牌：W1 → S1 → W2 → S2，放在隱藏區。過程中只把一般裝備用火箭載走，__虛化裝備間的連結不用解纏__",
