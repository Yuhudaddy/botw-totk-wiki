        ...
        sections: [
          ...
          },
          {
            ...
            steps: [
              ...
              "進入神廟或蓋房子的小遊戲",
              "用 __Overload Batch DI__ 獲得 20 把虛幽化武器（武器 C1 ～ C20）",
              "Smuggle C1 裝備 C2，按 R 放開投擲武器，按 Y 讓腳下的武器黏回手上",
              "重複步驟 4 __懲戒化（Purgatorify）__20 把虛幽化的武器",
              "再用相反的裝備做一次 __Overload Batch DI__，將 28 ~ 30 枚盾牌冷餘料在被懲戒化在手上的 20 把武器上，直到盾牌無法再被餘料為止",
          ...
          },
          {
            ...
            steps: [
              "觸發 [[Zuggle Overload|tab:Zuggle]]",
              "用 __Torch Batch DI__ 準備虛幽化的武器，直到武器不再被__假餘料__在盾上的 Overload Drop 武器上為止",
              "撿掉無法再被__假餘料__的武器，將其消滅後，卸掉武器",
              "解纏 Zuggled 武器的兩個母盾牌（間接餘料掉母件虛化盾牌、火箭載走母件正常盾牌）",
              "裝備任意武器把 Zuggle 的武器（Batch DI 的__冷餘料__母物件）丟出來放在旁邊",
