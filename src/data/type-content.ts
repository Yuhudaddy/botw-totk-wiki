...
export const typeContent: Record<string, TypeContent> = {
  ...
  "totk-12": {
    ...
    principle:
      "舊版本（～Ver.1.1.2）可以藉由裝備單手劍和餘料好裝置的盾牌，按住 ZL，按 Y 揮武器啟動雷龍頭，讓系統在同一幀判定「電掉中斷」+「你正要使用裝置」，讓盾牌上的裝置可以恆常啟動。新版本主要是想辦法「讓裝置被隱藏時啟動它」，這樣裝置只會記得它要啟動，沒有關閉。通常配合餘料糾纏或相似的程錯來達成這樣的遠端操作。",
    notes: [
