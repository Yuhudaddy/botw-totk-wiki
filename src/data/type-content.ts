  ...
  "totk-17": {
    methods: [
      ...
      },
      {
        ...
        tags: ["Ver.1.2.0+"],
        steps: [
          "準備好序章自動存檔，在舊檔案一把虛化武器 W1，讀檔回阿卡萊",
          {
            text: "虛化感染以下裝備，最終會獲得：",
            sub: [
              "虛化武器 W1",
          ...
          "用 W2 做可調式過載，並保留最後的 W2 裝備",
          "S1 Overload FE 一個浮空石 H",
          "W1 FS2FE 一個靠牆的SDC A1，並同時把它黏在 H 上",
          "Drop Smuggle S2",
          "把另一個操縱桿 A2 放到隱藏區，倒轉乾坤 A2，並把到餘料糾纏在 S2 上",
          "黏一顆蘋果在操縱桿 A2，並確認是否只有蘋果被隱藏，就能確保 A2 有隱藏儲存",
          "將 A2 黏在 A1、解除與 H 的黏合，並將兩個操縱桿都貼牆",
          "丟切卸 Smuggle W1、Drop Smuggle W2",
          "裝備任意武器和盾牌，倒轉乾坤 H、暫停、丟棄武器和盾牌，讀取序章存檔",
          "撿起 W2 直到武器欄滿，並且等到看得到 S2 的視窗之後，撿起 S2",
          "切換武器",
          "丟棄裝備中的武器，並切換到序章大師劍，關閉暫停",
          "等到你隱藏之後丟切序章大師劍",
          "關開暫停（__不用抓 5 幀內__）",
          "卸掉並裝備 S2，丟棄裝備中的武器之後讀取馬拉克古奇神廟的檔案",
          "到裡面撿起 SLD 掉在神廟內的序章大師劍",
        ],
        note: "※ 此方法改自1.1.2版的新流程，本站僅放 1.2.0+ 版以上的流程。",
      },
    ],
    notes: [
